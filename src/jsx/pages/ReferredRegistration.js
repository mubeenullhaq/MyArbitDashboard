                        ...
                        <nav className="nav nav-tabs border-bottom-0">
                          <div className="tab-content w-100" id="nav-tabContent">
                            <div className="tab-pane active show fade">
                              ...
                              {props.successMessage && <div className="">{props.successMessage}</div>}
                              <form className="dz-form py-2" onSubmit={onSignUp}>
                                <h3 className="form-title">Referral Sign Up</h3>
                        ...
                        <div className=" bottom-footer clearfix m-t10 m-b20 row text-center">
                          <div className="col-lg-12 text-center">
                            <span>
                              {" "}
                              © Copyright by
                              <span className={`heart ${heartActive ? "" : "heart-blast"}`} onClick={() => setHeartActive(!heartActive)}></span>
