...
import { getTotalsAction, getWithdrawlRequestTransactionsAction, updateWithdrawRequestAction } from "../../../store/actions/TransactionsActions";
                    ...
                    <div className="card-body p-4">
                      <div className="media">
                        ...
                        <div className="media-body text-white">
                          ...
                          <h3 className="text-white">{props.totals != 0 ? props.totals[0].total_deposite : ""}$</h3>
                    ...
                    <div className="card-body p-4">
                      <div className="media">
                        ...
                        <div className="media-body text-white">
                          ...
                          <h3 className="text-white">{props.totals != 0 ? props.totals[0].owe_sum : ""}$</h3>
                          <div className="progress mb-2 bg-secondary">
                            <div className="progress-bar progress-animated bg-white" style={{ width: "30%" }}></div>
                          </div>
                          <small>30% Increase in 30 Days</small>
                    ...
                    <div className="card-body p-4">
                      <div className="media">
                        ...
                        <div className="media-body text-white">
                          ...
                          <h3 className="text-white">{props.totals.length != 0 ? props.totals[0].total_withdrawls : ""}$</h3>
                          <div className="progress mb-2 bg-secondary">
                            <div className="progress-bar progress-animated bg-white" style={{ width: "30%" }}></div>
                          </div>
                          <small>30% Increase in 30 Days</small>
              ...
              <div class="row">
                    ...
                    <div className="card-body p-4">
                      <div className="media">
                        ...
                        <div className="media-body text-white">
                          ...
                          <h3 className="text-white">{props.totals.length != 0 ? props.totals[0].total_withdrawls_in_process : ""}$</h3>
                          <div className="progress mb-2 bg-secondary">
                            <div className="progress-bar progress-animated bg-white" style={{ width: "30%" }}></div>
                          </div>
                          <small>30% Increase in 30 Days</small>
                ...
                <div class="col d-flex  align-items-center">
                  <div className="card" style={{ backgroundColor: "transparent" }}>
                    ...
                    <button class="btn btn-primary shadow" onClick={handleRefreshTotals}>
                      Refresh Totals
                    </button>
                  </div>
                </div>
