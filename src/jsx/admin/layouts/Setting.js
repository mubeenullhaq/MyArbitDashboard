      ...
      <div className={`sidebar-right ${settingToggle ? "show" : ""}`}>
        ...
        <div className="sidebar-right-inner">
          ...
          <div className="note-text">
            <span className="text-danger">*Note :</span> This theme switcher is
            not part of product. It is only for demo. you will get all guideline
            in documentation. please check{" "}
            <a
              href="https://fooddesk.dexignlab.com/react/doc"
              target="_blank"
      ...
      <div className={`dz-demo-panel ${demoToggle ? "show" : ""}`}>
        ...
        <div className="dz-demo-inner">
          ...
          <div className="note-text">
            ...
            <a
              href="https://getskills.dexignzone.com/react/doc"
              target="_blank"
              className="text-primary"
            >
              {" "}
